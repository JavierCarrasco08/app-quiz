let history = {
  ...
  Instagram: {
    ...
    En abril de 2017, la empresa tenía 700 millones de usuarios activos, más del doble de la base total de usuarios de Twitter.
    `,
  },
  Twitter: {
    name: "Twitter",
...
export let questions = {
  YouTube: [
    ...
    },
    {
      ...
      a: "Created to play",
      b: "Chat application",
      c: "share videos worldwide",
      d: "I do not know",
    },
    {
      id: 4,
      question: "There were reliable sources before YouTube appeared.",
      a: "there were no reliable sources for one to share videos on the internet.",
      b: "there were reliable sources for one to share videos on the internet.",
    },
  ],
};
